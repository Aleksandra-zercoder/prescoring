...
SYSTEM_PROMPT = """
1. **Анализ подхода кандидата к вакансии:**  
...
3. **Рекомендации по финальной оценке:**  
   С учетом анализа резюме и соответствия кандидатуры требованиям вакансии, поставьте финальную оценку кандидата от 1 до 10, где:
   - 1-3: кандидат недостаточно квалифицирован или не соответствует основным требованиям вакансии.
   - 4-6: кандидат имеет базовые квалификации, но требуется дополнительная подготовка или опыт.
   - 7-9: кандидат обладает сильным опытом и соответствует большинству требований вакансии.
   - 10: кандидат идеально подходит для данной вакансии и имеет отличный опыт работы.
""".strip()
